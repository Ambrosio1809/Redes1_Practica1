...
24. prueba tabla html
        ...
        <table class="tg">
            <thead>
                <tr>
                    <th class="tg-xkfo">COLUMNAS</th>
                    <th class="tg-xkfo">IdPais</th>
                    <th class="tg-xkfo">iso_code</th>
                    <th class="tg-xkfo">location</th>
                </tr>
                </thead>
                <tbody>
                <tr>
                    <td class="tg-ncd7">RESTRICCIONES</td>
                    <td class="tg-ncd7">PK</td>
                    <td class="tg-ncd7">NN</td>
                    <td class="tg-ncd7">NN</td>
                </tr>
                <tr>
                    <td class="tg-0pky"></td>
                    <td class="tg-0pky">1</td>
                    <td class="tg-0pky">AFG</td>
                    <td class="tg-0pky">Afghanistan</td>
                </tr>
                <tr>
                    <td class="tg-0pky"></td>
                    <td class="tg-0pky">2</td>
                    <td class="tg-0pky">OWID_AFR</td>
                    <td class="tg-0pky">Africa</td>
                </tr>
                <tr>
                    <td class="tg-0pky"></td>
                    <td class="tg-0pky">3</td>
                    <td class="tg-0pky">ALB</td>
                    <td class="tg-0pky">Albania</td>
                </tr>
                <tr>
                    <td class="tg-0pky"></td>
                    <td class="tg-0pky">4</td>
                    <td class="tg-0pky">DZA</td>
